...
Dado o diagnóstico do modelo linear simples, optamos por analisar os dados de
forma  não paramétrica através da permutação, considerando que temos um modelo
com delineamento completamente aleatorizado (pela querida professora), usaremos
um teste de aleatorização (permutação) para testar a hipótese de que há efeito
do grupo no valor médio da retenção.
