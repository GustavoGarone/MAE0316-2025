...
Foi orientado atenção ao conteúdo longitudinal dos dados. Além das visitas,
podemos analisar a variável "ctime".
...
O gráfico da @fig-ctime mostra a dispersão dos dados ao longo do tempo contínuo.
Observa-se uma tendência de aumento da densidade mineral óssea com o passar do
tempo, mas não fica imediatamente claro se há uma diferença entre os grupos.
Analisaremos graficamente considerando as visitas como pontos no tempo.
